...
class Skin_Module_Media_Class extends Aitsu_Module_Abstract {
    ...
    protected function _main() {
        ...
        if ($this->_get('Media_' . $this->_index, $output)) {
        ...
        $template = Aitsu_Content_Config_Radio :: set($this->_index, 'MediaTemplate', '', $this->_getTemplates(), Aitsu_Translate::_("Template"));
        ...
        $files = Aitsu_Content_Config_Media :: set($this->_index, 'Image', Aitsu_Translate::_("Datei(en) w&auml;hlen"));
        $view->images = Aitsu_Persistence_View_Media :: byFileName(Aitsu_Registry :: get()->env->idart, $files);
        ...
        if (count($view->images) == 0) {
            if (Aitsu_Application_Status::isEdit()) {
                $output = '// Media '.$this->_index.' '.Aitsu_Translate::_("bearbeiten").' //';
            } else {
                $output = '';
            }
        } else {
